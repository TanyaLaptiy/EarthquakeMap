...
public class templateClientTestE {
   ...
   // ------------------------------------- get All to Obj -----------------------------------------------------
       ...
       ClientResponseE bookList2 = bookList.get(0);
        ...
        System.out.println("!!! SS2222222222 " +clientResponseE.getId());
        ...
        SessionResponseE sessionResponseE2 = template.getForObject(
                ...
                SessionResponseE.class,
                clientResponseE.getToken());
        //sessionsE/{token}
        System.out.println("!!! SS2222222222 " + sessionResponseE2.getToken());
